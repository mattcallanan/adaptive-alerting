...
public class JFreeTimeSeriesChartExample extends JFrame {
  private static final long serialVersionUID = 1L;

  public JFreeTimeSeriesChartExample(String title) {
    super(title);
    // Create dataset
  ...
  public static void main(String[] args) {
    SwingUtilities.invokeLater(() -> {
      JFreeTimeSeriesChartExample example = new JFreeTimeSeriesChartExample("Time Series Chart");
